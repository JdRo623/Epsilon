...
public class Level1Questions : MonoBehaviour {
    ...
    void Start () {
        ...
        PreguntaSingleton.GetInstance().SetPreguntaNivel1(pregunta1, respuestas);
        respuestas = new string[] { respuesta1Pregunta2, respuesta2Pregunta2, respuesta3Pregunta2 };
        PreguntaSingleton.GetInstance().SetPreguntaNivel1(pregunta2, respuestas);
        respuestas = new string[] { respuesta1Pregunta3, respuesta2Pregunta3, respuesta3Pregunta3 };
        PreguntaSingleton.GetInstance().SetPreguntaNivel1(pregunta3, respuestas);
        respuestas = new string[] { respuesta1Pregunta4, respuesta2Pregunta4, respuesta3Pregunta4 };
        PreguntaSingleton.GetInstance().SetPreguntaNivel1(pregunta4, respuestas);
    }
